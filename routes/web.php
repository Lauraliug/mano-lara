...
Route::group(['prefix' => 'authors'], function(){
 ...
 Route::group(['prefix' => 'books'], function(){
    ...
    Route::post('deletePhoto/{book}', [BookController::class, 'deletePhoto'])->name('book.deletePhoto');
    Route::post('updatePhoto/{book}', [BookController::class, 'updatePhoto'])->name('book.updatePhoto');
